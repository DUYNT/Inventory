...
<div class="x_panel">
	<div class="x_title">
		<h2>Danh sách tính chất xuất</h2>
					...
					<table id="datatable"
						...
						<thead>
							<tr role="row">
								...
								<th class="sorting" tabindex="0" aria-controls="datatable"
									...
									style="width: 426px;">Tính chất xuất</th>
								<th class="sorting" tabindex="0" aria-controls="datatable"
									rowspan="1" colspan="1"
						...
						<tbody>
							...
							<tr role="row" class="odd">
								...
								<td>3325</td>
								<td>Chuyển lệnh từ UHM sang HM</td>
								<td>Chuyển lệnh từ UHM sang HM</td>
							</tr>
							<tr role="row" class="odd">
	...
	<div class="x_content">
		...
		<div class="form-horizontal form-label-left input_mask">
			...
			<div class="col-md-12 col-sm-12 col-xs-12 "
				style="padding-bottom: 15px;">
				<label class="control-lable col-md-2 col-sm-2 col-xs-2"
					for="first-name" style="padding-top: 5px">Tính chất xuất</label>
				<div class="control-label col-md-10 col-sm-10 col-xs-10">
					<input type="text" class="form-control" id="inputSuccess3">
				</div>
			</div>
