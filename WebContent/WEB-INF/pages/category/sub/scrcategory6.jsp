					...
					<div class="radio" style="padding-right: 20px">
						<label class="">
							<div class="iradio_flat-green" style="position: relative;">
								...
								<ins class="iCheck-helper"
									style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; border: 0px; opacity: 0; background: rgb(255, 255, 255);"></ins>
							</div> Các d.nghiệp thuộc TCT XDVN
						</label>
					</div>
					<div class="radio" style="padding-right: 20px">
						<label class="">
						...
						<thead>
							<tr role="row">
								<th class="sorting_asc" tabindex="0" aria-controls="datatable"
									...
									style="width: 68px;">Mã NC.Cấp</th>
								<th class="sorting" tabindex="0" aria-controls="datatable"
									rowspan="1" colspan="1"
									aria-label="Position: activate to sort column ascending"
									style="width: 426px;">Tên nhà cung cấp</th>
								<th class="sorting" tabindex="0" aria-controls="datatable"
									rowspan="1" colspan="1"
		...
		<div class="form-horizontal form-label-left input_mask">
			<div class="col-md-12 col-sm-12 col-xs-12 "
				...
				<label class="control-lable col-md-2 col-sm-2 col-xs-2"
					for="first-name" style="padding-top: 5px">Mã NC.Cấp</label>
			...
			<div class="col-md-12 col-sm-12 col-xs-12 "
				style="padding-bottom: 15px;">
				<label class="control-lable col-md-2 col-sm-2 col-xs-2"
					for="first-name" style="padding-top: 5px">Tên nhà cung cấp</label>
				<div class="control-label col-md-10 col-sm-10 col-xs-10">
					<input type="text" class="form-control" id="inputSuccess3">
				</div>
			</div>
