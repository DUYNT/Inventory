...
<h3>FORM 7B</h3>
	<div class="x_panel">
		<div class="x_title">
			<h2>
				PHÂN TÍCH XUẤT DẦU MỠ ỨNG HẠN MỨC CHO ĐƠN VỊ
			</h2>
						...
						<table id="datatable"
							...
							<thead>
								<tr role="row">
									...
									<th class="sorting" tabindex="0" aria-controls="datatable"
										rowspan="2"
										aria-label=": activate to sort column ascending"
										style="width: 202px;">TỔNG CỘNG</th>
								</tr>
								<tr role="row">
							...
							<tbody>
								<tr role="row" class="even">
									<td rowspan="2" class="sorting_1">BC PHÁO BINH</td>
									<td rowspan="2"></td>
									<td rowspan="2"></td>
									<td>TM</td>
									<td></td>
								...
								<tr role="row" class="even">
									<td rowspan="2" class="sorting_1">CỤC TÀI CHÍNH</td>
									<td rowspan="2"></td>
									<td rowspan="2"></td>
									<td>TM</td>
									<td></td>
								...
								<tr role="row" class="even">
									<td rowspan="2" class="sorting_1">TC HẬU CẦN</td>
									<td rowspan="2"></td>
									<td rowspan="2"></td>
									<td>TM</td>
									<td></td>
