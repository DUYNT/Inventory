					...
					<div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3"
						...
						<button type="button" class="btn btn-primary">
							<div class="fa-hover col-md-3 col-sm-4 col-xs-12">
								<a data-toggle="modal" data-target="#modal-report-total" href="#/plus" style="color: white;"><i class="fa fa-plus"></i>
									Tạo phiếu mới</a>
							</div>
						</button>
						<button type="button" class="btn btn-primary">
		...
		<div id="datatable_wrapper"
			...
			<div class="row">
				<button type="button" class="btn btn-success" data-toggle="modal"
					data-target="#modal-quan-ly-phieu-nhap-1" style="float: right;">
					<div class="fa-hover col-md-3 col-sm-4 col-xs-12">
						...
						<thead>
							<tr role="row">
								...
								<th class="sorting" tabindex="0" aria-controls="datatable"
									rowspan="1" colspan="1"
									aria-label="Salary: activate to sort column ascending"
									style="width: 154px;">Trong lượng</th>
								<th class="sorting" tabindex="0" aria-controls="datatable"
									rowspan="1" colspan="1"
									aria-label="Salary: activate to sort column ascending"
									style="width: 154px;">Tỷ trọng</th>
								<th class="sorting" tabindex="0" aria-controls="datatable"
									rowspan="1" colspan="1"
									aria-label="Salary: activate to sort column ascending"
								...
								<th class="sorting" tabindex="0" aria-controls="datatable"
									rowspan="1" colspan="1"
									aria-label="Salary: activate to sort column ascending"
									style="width: 154px;">ĐG Mua</th>
								<th class="sorting" tabindex="0" aria-controls="datatable"
									rowspan="1" colspan="1"
									aria-label="Salary: activate to sort column ascending"
									style="width: 154px;">ĐG QLý</th>
								<th class="sorting" tabindex="0" aria-controls="datatable"
									rowspan="1" colspan="1"
									aria-label="Salary: activate to sort column ascending"
...
<tiles:insert definition="PHIEUNHAP1" />
<tiles:insert definition="PHIEUNHAP2" />
<tiles:insert definition="PHIEUNHAP3" />