...
<div class="row">
	...
	<div class="x_content">
		...
		<div class="form-horizontal form-label-left input_mask">
			...
			<div class="form-group">
				<label class="control-label col-md-3 col-sm-3 col-xs-12">Nhóm vật tư</label>
				<div class="control-label col-md-9 col-sm-9 col-xs-12">
					<select class="form-control">
			...
			<div class="form-group">
				<label class="control-label col-md-3 col-sm-3 col-xs-12">Vật tư</label>
				<div class="control-label col-md-9 col-sm-9 col-xs-12">
					<select class="form-control">
			...
			<div class="form-group">
				<label class="control-label col-md-3 col-sm-3 col-xs-12">Kho chứa</label>
				<div class="control-label col-md-9 col-sm-9 col-xs-12">
					<select class="form-control">
              ...
              <div class="col-md-6 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br>
                    <div class="jumbotron">
                      <p style="text-align: center;">Chức năng này cho phép xem cân đối xuất nhập tồn theo các định kỳ</p>
                    </div>
                    </div>
                </div>
              </div>
...
<div class="x_panel">
	<div class="x_title">
		<h2>Danh sách hàng hóa <small> thực tế đang tồn tại</small></h2>
		<ul class="nav navbar-right panel_toolbox">
			<li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
			</li>
			<li class="dropdown"><a href="#" class="dropdown-toggle"
