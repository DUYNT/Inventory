...
/**
 * AuthoritiesResultValue class archive info screen Authorities
 */
@Component("AuthoritiesResultValue")
@Scope("request")
public class AuthoritiesResultValue extends BaseValue implements InfoValueIF, Serializable {
    /**
     * 
     */
