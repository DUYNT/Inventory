package com.tecapro.inventory.total.bean;
...
@Scope("request")
public class TotalValue extends BaseValue implements InfoValueIF, Serializable {
    /**
     * 
     */
    private static final long serialVersionUID = 1609009477266477879L;
   
    private ResultValue resultValue = new ResultValue();
